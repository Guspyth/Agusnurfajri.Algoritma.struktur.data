...
// Pemetaan nama ? indeks
map<string,int> idx;

// Matriks next untuk FloydWarshall
vector< vector<int> > fw_next;

// Rekonstruksi jalur Floyd dari u ke v
...
// Dijkstra: mengembalikan (dist[], parent[])
...
int main(){
    ...
    cout<<"2. Cetak semua jarak terpendek (floyd warshall)\n";
